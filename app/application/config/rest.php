...
$config['auth_override_class_method']['status']['index'] = 'none';
...
|--------------------------------------------------------------------------
|
| Configure wether or not api keys should expire, and the column name to match e.g. my_key
|
*/
