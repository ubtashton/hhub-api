...
|--------------------------------------------------------------------------
|
| Autoload funtion for custom controllers etc.
|
*/
...
*/
$config['composer_autoload'] = getenv('COMPOSER_AUTOLOAD') ? getenv('COMPOSER_AUTOLOAD') : false;
...
|
*/
$config['sess_driver'] = getenv('SESS_DRIVER') ? getenv('SESS_DRIVER') : 'files';
$config['sess_cookie_name'] = getenv('SESS_NAME') ? getenv('SESS_NAME') : 'ci_session';
$config['sess_expiration'] = 1296000;
$config['sess_save_path'] = getenv('SESS_SAVE_PATH') ? getenv('SESS_SAVE_PATH') : 'ci_session';
...
|
*/
$config['compress_output'] = getenv('ENABLE_GZIP') ? getenv('ENABLE_GZIP') : false;
...
*/
$config['proxy_ips'] = getenv('PROXY_IPS') ? getenv('PROXY_IPS') : '';
